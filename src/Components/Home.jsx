    ...
    <>
      <div className="h-screen w-screen relative">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute text-[#A4FFAF] text-xl md:text-2xl font-semibold animate-pulse" style={{ top: '20%', left: '10%' }}>
            copy
          </div>
          <div className="absolute text-[#A4FFAF] text-xl md:text-2xl font-semibold animate-pulse" style={{ top: '30%', left: '70%' }}>
            paste
          </div>
          <div className="absolute text-[#A4FFAF] text-xl md:text-2xl font-semibold animate-pulse" style={{ top: '50%', left: '20%' }}>
            share
          </div>
          <div className="absolute text-[#A4FFAF] text-xl md:text-2xl font-semibold animate-pulse" style={{ top: '70%', left: '80%' }}>
            type
          </div>
          <div className="absolute text-[#A4FFAF] text-xl md:text-2xl font-semibold animate-pulse" style={{ top: '60%', left: '40%' }}>
            text
          </div>
        </div>
      </div>
